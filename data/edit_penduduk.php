            ...
            ?>  
                    <form action="update/u_penduduk.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desa" name="desa"  value="<?php echo $row['desa'];?>" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>

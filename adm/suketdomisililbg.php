                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  placeholder="Alamat Lengkap Lembaga" required class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh Rt. 001/Rw. 002 Desa Pamulihan Kec. Way Sulan Kab. Lampung Selatan Prov. Lampung</small></div>
                                    </div>
                                    <div class="row form-group">

                    ...
                    <form action="update/u_sutarpindah.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan"  value="<?php echo $dt[2]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Desa Pamulihan Kec. Way Sulan Kab. Lampung Selatan</small></div>
                                    </div>
                                    <div class="row form-group">

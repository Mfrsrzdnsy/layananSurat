                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desa" name="desa" value="<?php echo $dt[10];?>" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desai" name="desai" value="<?php echo $dt[21];?>" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>

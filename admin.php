...
<body class="animsition">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li><a href='?page=jenissurat' title='Dat Jenis Surat'>Jenis Surat</a></li>
                        <li><a href='?page=klasifikasi' title='Data Klasifikasi Surat'>Klasifikasi</a></li>
                        <li><a href='?page=staff' title='Data Staff'>Data Staff</a></li>
                        ...
                        <div class="header-wrap">
                                           ...
                                           while ($rr = mysqli_fetch_array($queryy)){
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="fotowarga/<?php echo $rr['foto'];?>" alt="Sri" />
                                                </div>
                                                <div class="content">
                            ...
                            ?>
                                            <div class="notifi__item">
                                                ...
                                                <div class="content">
                                                    <p><a
                                                            href="?page=acc&amp;id=<?php echo $rx['id'];?>"><?php echo $rx['nama'];?></a>
                                                        <span
                                                            class="date pull pull-right"><?php echo $rx['tgl'];?></span><br><?php echo $rx['nmsurat'];?>
                                                    </p>
                            ...
                            ?>
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="foto/<?php echo $radm['foto'];?>" alt="Sri" />
                                        </div>
                                        <div class="content">
    ...
    <!-- Tabrakan dengan Jquery panggil data penduduk-->
    <!-- Bootstrap JS-->

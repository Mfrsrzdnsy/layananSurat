...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr> <tr>Tmp. & Tgl. Lahir</td><td>:</td><td><?php echo $r['tmp_lahir'];?>, <?php echo $r['tgl_lahir'];?></td>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Berdasarkan Laporan dari kepala wilayah Selaparang, Desa Selaparang dan sepanjang pengetahuan kami bahwa orang tersebut diatas memang benar TELAH BERCERAI dengan seorang perempuan:</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    ...
    <tr>
    <td>Tanggal</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
    <tr>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</td>
  </tr>

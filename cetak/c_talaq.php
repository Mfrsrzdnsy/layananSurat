...
$query = mysqli_query($con, "SELECT t_jenissurat.*, t_datasurat.*, t_detailsurat.*, t_penduduk.* 
                             FROM t_jenissurat, t_datasurat, t_detailsurat, t_penduduk 
                             WHERE t_detailsurat.kode='$kodesurat' 
                             AND t_detailsurat.nik=t_penduduk.nik");
...
<html>
<head>
    <title>Surat Keterangan Talaq/Cerai</title>
...
<body onLoad="window.print()">
    ...
    <table width="800" align="center" border="0" cellspacing="1" cellpadding="4" class="table-print">
        ...
        <tr>
            <td colspan="" align="center">
                <strong>
                    <font size=3 color="black">KECAMATAN <?php echo strtoupper($rd['kec']);?></font>
                </strong>
            </td>
            <td width="70"></td>
        </tr>
        ...
        <tr>
            <td colspan="3" align="center">
                <hr>
                <font size=2 color="black"><i>Sekretariat : <?php echo $rd['kantor'];?></i></font>
                <hr size="3">
            </td>
        </tr>
        <tr>
            <td colspan="3" align="center">
                <strong>
                    <font size=4 color="black"><u>SURAT KETERANGAN TALAQ/CERAI</u></font>
                </strong><br>
                <font size=2 color="black">Nomor: 472.2/245/Ds.SLPRG/2023</font>
            </td>
        </tr>
    </table>
    <br>
    <table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
        ...
        <tr>
            <td colspan="3">Berdasarkan laporan dari Kepala Wilayah Selaparang Barat Desa Selaparang dan sepanjang pengetahuan kami bahwa orang tersebut diatas memang benar TELAH BERCERAI dengan seorang perempuan:</td>
        </tr>
        <tr>
            <td>Nama</td>
            <td>:</td>

                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan"  placeholder="Isi dengan alamat tujuan pindah" class="form-control"><small class="form-text text-muted">Contoh : Desa Pamulihan Kec. Way Sulan Kab. Lampung Selatan</small></div>
                                    </div>
                                    <div class="row form-group">

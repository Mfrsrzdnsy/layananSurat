                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    ?>
                                                <div class="col-12 col-md-9"><input type="text" id="nmsurat" name="nmsurat" class="form-control" value="<?php echo $r['nmsurat'];?>" readonly> </div>
                                    </div>
                                    <?php
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="status perkawinan" class=" form-control-label">Status Perkawinan</label></div>
                                        <div class="col-12 col-md-4">
                                            <select name="status perkawinan" id="status perkawinan" readonly="readonly" class="form-control">
                                                <option value="-" selected="selected">Status Perkawinan</option>
                                                <option value="IBelum Menikah">Belum Menikah</option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt" placeholder="Kp. Durian Runtuh, RT./RW. 001/002" class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh, RT./RW. 001/002</small></div>
                                    </div>

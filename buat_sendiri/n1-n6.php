        ...
        <div class="tab-content pl-3 pt-2" id="nav-tabContent">
            <div class="tab-pane fade show active" id="Cs" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desaa" name="desaa"  placeholder="Desa" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
             ...
             <div class="tab-pane fade" id="Ci" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desab" name="desab"  placeholder="Desa" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
                                    <div class="row form-group">
         ...
         <div class="tab-pane fade" id="Ibu" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="desa1" name="desa1"  placeholder="Desa" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
                                    <div class="row form-group">

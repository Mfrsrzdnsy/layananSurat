...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2023 at 02:14 AM
...
(1, 'juliani', 'juliani28@gmail.com', '085955159306', 'Medana', '202cb962ac59075b964b07152d234b70', '2021-08-15', '814dd4f9cfd9b13b5dab0c54c47cdcf57f.jpg', 'admin', '18-11-2023 8:09', 'off'),
(2, 'sdccreator', 'sdccreator12@gmail.com', '082278183799', 'Dagelan', '202cb962ac59075b964b07152d234b70', '2021-08-15', 'petugas.png', 'staff', '12-06-2023 7:22', 'off');
...
--
-- Table structure for table `t_buatsendiri`
--
...
--
-- Dumping data for table `t_buatsendiri`
--

INSERT INTO `t_buatsendiri` (`id`, `nik`, `nama`, `kode_surat`, `kode_jenis`, `no_surat`, `nmsurat`, `tgl`, `status`) VALUES
(1, '1811010712610002', 'SUBEKI', 'SR001', 'JS001', '475.43/001/VI/2023', 'Surat Keterangan Usaha', '2023-06-14', 'acc'),
(2, '3671074510920006', 'SITI SENI WATI', 'SR002', 'JS001', '475.43/002/XI/2023', 'Surat Keterangan Usaha', '2023-11-18', 'acc'),
(3, '1801235507820005', 'ENI TIARAWATI', 'SR003', 'JS008', '500/003/XI/2023', 'Surat Keterangan Penghasilan', '2023-11-18', 'acc');
...
CREATE TABLE `t_datapdinas` (
  `id` int(5) NOT NULL,
  `kodepd` varchar(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `nm` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
--
-- Dumping data for table `t_datasurat`
--

INSERT INTO `t_datasurat` (`id`, `kode`, `kodejenis`, `nmsurat`, `no`, `id_stf`, `tanggal`, `status`) VALUES
(1, 'SR001', 'JS001', 'Surat Keterangan Usaha', '475.43/001/VI/2023', '1811010712610002', '2023-06-14', 'acc'),
(2, 'SR002', 'JS001', 'Surat Keterangan Usaha', '475.43/002/XI/2023', '3671074510920006', '2023-11-18', 'acc'),
(3, 'SR003', 'JS008', 'Surat Keterangan Penghasilan', '500/003/XI/2023', '1801235507820005', '2023-11-18', 'acc');
...
CREATE TABLE `t_dataundangan` (
  `id` int(5) NOT NULL,
  `kodeu` varchar(8) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `nm` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '2004', 'Medana', '23', 'Tanjung', '01', 'Lombok Utara', '18', 'Nusa Tenggara Barat', 'Jl. Pemuda No. 01 Desa Medana Kec. Tanjung Kab. Lombok Utara, POS : 35522', '0822-7818-3799', 'Lalu Didiq Cahyadi', '19821220 199015 1 003', 'SAMANI, S.Kom', '19850412 199615 1 005', 'MARSIH', 'desamdna@gmail.com', '1594logos.png');

-- --------------------------------------------------------

--
-- Table structure for table `t_detailsurat`
--
...
--
-- Dumping data for table `t_detailsurat`
--

INSERT INTO `t_detailsurat` (`id`, `kode`, `kodejenis`, `nmsurat`, `no`, `nik`, `nama`, `detail`, `tanggal`, `ttd`, `qrcode`, `id_ptg`) VALUES
(1, 'SR001', 'JS001', 'Surat Keterangan Usaha', '475.43/001/VI/2023', '1811010712610002', 'SUBEKI', 'Pertanian Jagung;2015;Dusun Tegal Sari Rt. 004/Rw. 002 Desa Dagelan', '2023-06-14', 'SAPARUDIN', 'f884127d3b57c9cd2f6dc59aeeaf1594.png', '1811010712610002'),
(2, 'SR002', 'JS001', 'Surat Keterangan Usaha', '475.43/002/XI/2023', '3671074510920006', 'SITI SENI WATI', 'gjhu;12345678;kjasdisa', '2023-11-18', 'SAPARUDIN', '32c1b5e734a18c8ffe000960089e67fa.png', '3671074510920006'),
(3, 'SR003', 'JS008', 'Surat Keterangan Penghasilan', '500/003/XI/2023', '1801235507820005', 'ENI TIARAWATI', '13124;fhdth', '2023-11-18', 'Lalu Didiq Cahyadi', 'c444431f06035d9006387948576f74bb.png', '1801235507820005');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Jangan dikosongkan';
...
(5, '3275022901090024', '1801235507820005', 'ENI TIARAWATI', 'Perempuan', 'SUMBER AGUNG', '29/12/1979', 'Indonesia', 'Islam', 'Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', 'Anak', '-', 'off'),
(6, '3275022901090024', '1801232203020003', 'WILSON KHARISMAWAN', 'Laki-laki', 'PAMULIHAN', '25/05/2002', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', '-', '-', ''),
(7, '3275022901090024', '1801234905030001', 'RAHMA ASMANADIA', 'Perempuan', 'SUMBER AGUNG', '09/05/2003', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Tegal Sari Rt./Rw. 001/001', '00', '-', '-', ''),
(9, '1811012505110041', '1811013011050001', 'SODIKIN', 'Laki-laki', 'MESUJI', '30/11/2005', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 004/002', '082374987389', '-', '-', ''),
(10, '1811012505110041', '1811011307990001', 'SLAMET', 'Laki-laki', 'KALIANDA', '13/07/1996', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 004/002', '082374987389', '-', '-', ''),
(11, '1811012505110041', '1811010712610002', 'SUBEKI', 'Laki-laki', 'MEDAN', '07/12/1961', 'Indonesia', 'Islam', 'Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Tegal Sari Rt./Rw. 004/002', '082374987389', '-', '-', 'on'),
(12, '1811012505110041', '1811014806650002', 'SRI MASKANTI', 'Perempuan', 'JAWA TIMUR', '08/06/1965', 'Indonesia', 'Islam', 'Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Tegal Sari Rt./Rw. 004/002', '082374987389', '-', '-', ''),
(13, '1807201902180009', '1807201707880003', 'SUPRIYANTO', 'Laki-laki', 'SINAR JATI', '07/05/1991', 'Indonesia', 'Islam', 'Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', '-', '-', ''),
(14, '1807201902180009', '1801234702000001', 'EKA SUSANTI', 'Perempuan', 'PEMULIHAN', '07/01/2000', 'Indonesia', 'Islam', 'Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', '-', '-', ''),
(15, '1807201902180009', '1801232006180003', 'MUHAMAD ELFAHRI', 'Laki-laki', 'PEMULIHAN', '20/06/2018', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Nusa Tenggara Barat', 'Lombok Utara', 'Tanjung', 'Medana', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', '-', '-', ''),
(16, '1807201902180009', '1801232006180002', 'MUHAMAD ALFAHMI', 'Laki-laki', 'PEMULIHAN', '20/06/2018', '', 'Islam', 'Belum Kawin', '-', '-', 'Lampung', 'Lampung Selatan', 'Way Sulan', 'Pamulihan', 'Dusun Sinar Jaya Rt./Rw. 001/001', '00', '-', '-', ''),
...
(20, '1807201609140010', '1801239999999901', 'NADHIFA KANIA PUTRI', 'Perempuan', 'PEMULIHAN', '01/03/2021', 'Indonesia', 'Islam', 'Belum Kawin', '-', '-', 'Lampung', 'Lampung Selatan', 'Way Sulan', 'Pamulihan', 'Dusun Tegal Sari Rt./Rw. 003/001', '00', '-', '-', ''),
...
(1, '1811010712610002', 'SUBEKI', 'JS002', 'Surat Keterangan Tempat Usaha', 'sukettmpusaha', '085764458877', '82ERY KARMAN.jpg', '35Sam.jpg', '2023-06-14 00:00:00', 'acc');
...
--
-- Indexes for table `t_buatsendiri`
--
...
--
-- Indexes for table `t_detailsurat`
--
...
--
-- AUTO_INCREMENT for table `t_buatsendiri`
--
ALTER TABLE `t_buatsendiri`
...
--
-- AUTO_INCREMENT for table `t_detailsurat`
--
ALTER TABLE `t_detailsurat`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `t_penduduk`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1593;
